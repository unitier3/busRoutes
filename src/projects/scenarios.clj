...
(def busRoutes00
  '{
    ...
    :middlesbrough ({:location "japan" :cost 2} {:location "newcastle" :cost 3})
    :japan ({:location "tokyo" :cost 2})
    :tokyo ({:location "india" :cost 2})
    :india ({:location "hongKong" :cost 2})
    :hongKong ({:location "florida" :cost 2})
...
(def busRoutes02
  '{
    :newcastle ({:location "york" :cost 6}{:location "darlington" :cost 8})
    :york ( {:location "darlington" :cost 2} {:location "manchester" :cost 6} {:location "newcastle" :cost 4} {:location "durham" :cost 3}{:location "chester" :cost 26})
    ...
    :middlesbrough ({:location "chester" :cost 6}{:location "durham" :cost 6})
